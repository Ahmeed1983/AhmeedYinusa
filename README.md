...
Public research code is provided only when a complete implementation or complete notebook can be confidently associated with the corresponding study.

For other studies, researchers are welcome to request notebooks, scripts, models, configuration details, or supporting research materials when available and shareable. Availability may depend on the materials retained from the study and on applicable data, licensing, coauthor, institutional, or publication restrictions.
...
**Research materials:** Supporting notebooks and implementation materials may be requested for research use when available and shareable.
...
**Research materials:** Computational materials may be requested for research use when available and shareable.
...
**Research materials:** Supporting materials may be requested from the authors where available.
...
**Research materials:** Supporting model materials may be requested for research use when available and shareable.
...
**Research materials:** Supporting model and research materials may be requested for research use when available and shareable.
...
**Research materials:** Supporting analytical materials may be requested for research use when available and shareable.
...
**Research materials:** Supporting notes and related materials may be requested where available.
